...
// BambooRotateLog 代表会进行切割的日志文件存储
type BambooRotateLog struct {
	BambooLog
...
// NewBambooRotateLog 实例化BambooRotateLog
func NewBambooRotateLog(params ...interface{}) (interface{}, error) {
	// 参数解析
	...
	// 从配置文件中获取file信息，否则使用默认的bamboo.log
	file := "bamboo.log"
