...
// NewBambooSingleLog params sequence: level, ctxFielder, Formatter, map[string]interface(folder/file)
func NewBambooSingleLog(params ...interface{}) (interface{}, error) {
