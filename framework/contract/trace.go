...
type Trace interface {
	// // SetTraceIDService set TraceID generator, default bambooIDGenerator
	// SetTraceIDService(IDService)
	// // SetTraceIDService set SpanID generator, default bambooIDGenerator
