...
import (
	"github.com/llzzrrr1997/bamboo/app/console/command/demo"
	"github.com/llzzrrr1997/bamboo/framework"
	"github.com/llzzrrr1997/bamboo/framework/cobra"
	"github.com/llzzrrr1997/bamboo/framework/command"
)
...
func RunCommand(container framework.Container) error {
	...
	var rootCmd = &cobra.Command{
		...
		Short: "bamboo 命令",
		// 根命令的详细介绍
		Long: "bamboo 框架提供的命令行工具，使用这个命令行工具能很方便执行框架自带命令，也能很方便编写业务命令",
		// 根命令的执行函数
